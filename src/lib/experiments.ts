...
export function getExperiment(experiments: Experiment[], slug: string): Experiment | undefined {
    return experiments.find(e => e.slug === slug)
}

export function getByCategory(experiments: Experiment[], category: Category): Experiment[] {
    return experiments.filter(e => e.category === category)
}

export function getAdjacentExperiments(experiments: Experiment[], slug: string, category: Category): { prev: Experiment | null; next: Experiment | null } {
